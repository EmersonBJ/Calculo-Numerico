...
import math
#O metodo do ponto fixo[1] e descrito como
#φ(x) = x + A(x)f(x) ;  A(x*) != 0
#A partir disso, o problema de encontrar a raiz de f se torna o provlema de encontrar o RF de Q -> Q(x') =  x*

import numpy as np
np.float32(1.0004545454)
print (np.float32(1.0004545454)) # Exemplo de arredondamento para float32, mostrando a perda de precisão.
